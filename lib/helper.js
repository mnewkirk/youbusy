...
Helper.prototype.deriveCalendarOptions = function(arguments, customization) {
  ...
  options['timeMax'] = arguments['timeMax'] ? moment(arguments['timeMax']).toISOString() : (new Date()).toISOString();
  options['timeMin'] = arguments['timeMin'] ? moment(arguments['timeMin']).toISOString() : defaultTimeMin;
